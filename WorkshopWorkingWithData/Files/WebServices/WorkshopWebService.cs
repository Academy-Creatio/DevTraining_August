...
namespace WorkshopWorkingWithData
{
	...
	public class WorkshopWebService : BaseService
	{
		...
		{
			//http://k_krylov:7020/0/rest/WorkshopWebService/GetFilteredContacts?qt=0&email=a.baker@ac.com	
			Timer.Start();
			Tuple<DataTable, string> result;
			switch (qt)
			{
		...
		// Example to run: 
		// http://k_krylov:7020/0/rest/WorkshopWebService/GetAllDataReverseJoin?qt=1
			Timer.Start();
			Tuple<DataTable, string> result;
			switch (qt)
			{
		...
		{
			// http://k_krylov:7020/0/rest/WorkshopWebService/GetContactsWithMinutes?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00
			Timer.Start();
			Tuple<DataTable, string> result;
			switch (qt)
			{
		...
		{
			// http://k_krylov:7020/0/rest/WorkshopWebService/UpdateContactName?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00&NewName=Kirill
			Timer.Start();
